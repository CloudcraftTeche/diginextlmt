  ...
  const SocialIcon = ({ type, href }: { type: string; href?: string }) => {
    ...
    return (
      <a
        ...
        className="w-8 h-8 sm:w-10 sm:h-10 bg-gray-800 hover:bg-orange-500 rounded-full flex items-center justify-center text-gray-300 hover:text-white transition-all duration-300 hover:scale-110"
      ...
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="bg-black rounded-xl p-6 sm:p-8 lg:p-12">
          <div className="max-w-7xl mx-auto">
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center mb-12 lg:mb-16">
                {/* Newsletter Title and Description */}
                <div className="text-center lg:text-left">
                  <h2 className="text-lg sm:text-xl lg:text-2xl font-medium text-white mb-4 sm:mb-6 leading-tight">
                    {newsletter.title}
                  </h2>
                ...
                {/* Newsletter Form */}
                <div className="flex flex-col sm:flex-row gap-0 max-w-full mx-auto lg:max-w-full">
                  <input
                    type="email"
                    value={email}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-6 sm:gap-8 lg:gap-12">
                ...
                <div className="sm:col-span-2 lg:col-span-2">
                  <Image
                    ...
                    width={300}
                    height={80}
                    className="h-16 sm:h-20 w-auto transition-all duration-300 hover:scale-105 mb-4 sm:mb-6"
                    priority
                  />
                  ...
                  <ul className="space-y-2 sm:space-y-3">
                    {services.map((service, index) => (
                      <li key={index}>
                        <a
                          href="#"
                          className="text-gray-300 text-xs sm:text-sm hover:text-orange-400 transition-colors duration-300"
                        >
                          {service}
                        </a>
                      </li>
            ...
            {/* Bottom Section */}
            <div
              className={`mt-8 sm:mt-12 lg:mt-16 transition-all duration-700 ease-out ${
                isVisible
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-4"
              }`}
            ...
            >
              ...
              <div className="flex items-center justify-center mb-6 sm:mb-8">
                {/* Left Line */}
                <div className="flex-1 h-px bg-gray-700 mr-4 sm:mr-8"></div>
                ...
                {/* Right Line */}
                <div className="flex-1 h-px bg-gray-700 ml-4 sm:ml-8"></div>
              </div>
